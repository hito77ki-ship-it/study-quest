...
const ARTICLES = {
  ...
  'boki-net-id-check.html': {label:'簿記3級・2級', title:'簿記ネット試験の本人確認書類｜保険証は使える？当日に確認する5点'},
  ...
  'cpa-akirameta-shinro.html': {label:'会計士の進路', title:'公認会計士を諦めた後の進路は？4つの選択肢と確認すること', thumb:'images/cpa-shinro-flow-map.svg?v=20260909', hero:false, dialogue:false, reflection:false},
  ...
  'fp3-iminai.html':           {label:'FP3級',       title:'FP3級は意味ない？取る価値を整理', thumb:'images/article-diagrams/fp3-iminai.svg'},
  'fp3-nannichi.html':         {label:'FP3級',       title:'FP3級のCBT試験日程と学習計画', thumb:'images/article-diagrams/fp3-nannichi.svg'},
...
const ORIGINALITY_NOTES = {
  ...
  'boki3-genkin.html': {
    title: '小切手を見たら、振出人を先に見る',
    lead: '若葉が「現金の範囲」で一度手を止めた経験から、このページでは用語を増やす前に、問題文のどこを見るかを固定しています。小切手を受け取ったら、まず振出人、次に直ちに当座預金へ入れたかを確認します。',
    points: [
      '取引先が振り出した小切手を受け取っただけなら、通貨代用証券として「現金」を考える。',
      '当社が以前に振り出した小切手なら、「自己振出小切手」として当座預金の減少を取り消す。',
      '取引先振出でも、直ちに当座預金へ預け入れたと書かれていれば、現金を経由せず当座預金で処理する。'
    ]
  },
  'cpa-dokugaku.html': {
...
const ARTICLE_DIALOGUES = {
  'toeic-600.html': [
    ['question', '受験生', '公式問題集のPart7を開いたら、長文が大量すぎて……全部ちゃんと読まなきゃと思ったら、それだけで心が折れました。'],
    ['note', '若葉', 'その気持ち、めちゃくちゃ分かります。でも600点突破のチート技は、満点を狙いにいかないことなんだ！全部読もうとするから絶望するんだよ。'],
    ['question', '受験生', 'え、読まなくていいんですか……？'],
    ['note', '若葉', 'まずは点数が伸びやすいリスニングと、パターンで秒殺できるPart5の「文法・単語のハコ」を最優先で味方につける。そしてPart7の最後は、綺麗に塗り絵（選択肢を統一してマーク）する。600点はそういう割り切りゲームなんだよ。']
  ],
  'fe-vs-ap.html': [
    ['question', '受験生', 'プログラミングが本当に苦手で、基本情報の午後試験（アルゴリズム必須）が不安すぎます……。'],
    ['note', '若葉', 'その悩み、めちゃくちゃ分かります。実はプログラミングが苦手なら、無理に基本情報で消耗するより、最初から応用情報を狙う手もあるんだよ。'],
    ['question', '受験生', 'え、応用情報の方が難しいんじゃないんですか？'],
    ['note', '若葉', '応用情報の午後試験は11題から5題を選べるから、「経営戦略」「サービスマネジメント」みたいな文系科目だけで固めれば、プログラミングなしで合格ラインに届く。実は基本情報より戦いやすいケースもあるんだよ。']
  ],
  'daigakusei-keizai-shikaku.html': [
    ['question', '後輩', 'なんとなく周りに流されて、就活のためにTOEICでも受けようかなと思ってます……600点くらい取れれば安心ですよね？'],
    ['note', '若葉', 'ちょっと待って。経済・経営学部の最大の強みは「数字（会計）が読めること」なんだ。評価のブレが大きい英語に先に逃げる前に、市場価値がほぼ確定している日商簿記2級のハコ（盾）を最優先で回収しにいくのが、一番賢いチート戦略だよ。'],
    ['question', '後輩', 'TOEICより簿記の方が優先なんですか？意外です……。'],
    ['note', '若葉', 'TOEIC600点台は、正直なところ就活市場ではほとんど評価されないのが現実。同じ時間を使うなら簿記2級を取った方が、面接官の反応は全然違う。英語は簿記を固めてから、730点以上を本気で狙う方が費用対効果が高いよ。']
  ],
  'boki2-moshi-honban.html': [
    ['question', '受験生', '模試だと7割取れるのに、本番の過去問だと急に解けなくなります……。自分は本番に弱いんでしょうか？'],
    ['note', '若葉', 'その結論、実はちょっと早いです。原因は「性格」じゃなく、①言い回しへの対応力②時間配分③特定分野の穴のどれかであることがほとんどですよ。'],
    ['question', '受験生', 'どうやって見分ければいいですか？'],
    ['note', '若葉', '直近の模試の間違いを「知識不足・読み取りミス・計算ミス・時間切れ」に分類してみてください。どれが一番多いかで、直す場所がかなり絞れます。']
  ],
  'boki2-cbt-vs-paper.html': [
    ['question', '受験生', 'ネット試験と紙の試験、どっちの方が合格しやすいですか？'],
    ['note', '若葉', '難易度の安定性はCBTが有利です。ただし2級は複雑な下書きが増えるので、PC画面だと計算用紙のやりくりが大変になります。どちらが合うかは自分のスタイル次第です。'],
    ['question', '受験生', '計算用紙って、どうやって工夫すればいいですか？'],
    ['note', '若葉', '1枚を4分割して、問題番号ごとにエリアを決めておくのが一番です。本番前の模試で練習しておくと焦らなくなります。']
  ],
  'boki2-next-exam.html': [
    ['question', '受験生', 'ネット試験って、統一試験より難しかったりしますか？'],
    ['note', '若葉', '試験範囲も合格基準（70点）も同じです。問題がランダム出題なのでヤマを張りにくいですが、それはお互い様なので気にしなくていいです。'],
    ['question', '受験生', '3ヶ月で本当に間に合いますか？'],
    ['note', '若葉', '1日2〜3時間確保できれば十分狙えます。ネット試験は「準備できたら受ける」ができるので、3ヶ月があくまで目安。仕上がったタイミングで即申し込みが最速ルートです。']
  ],
  'boki2.html': [
    ['question', '受験生', '簿記2級って、3級の延長だと思って始めても大丈夫ですか？'],
    ['note', '若葉', '半分はその通りです。ただ、工業簿記はまったく新しい科目なので、3級の延長だけで考えると途中で止まりやすいです。'],
    ['question', '受験生', 'じゃあ最初に何を意識すればいいですか？'],
    ['note', '若葉', '商業簿記を進めながら、早い段階で工業簿記の全体像だけでも見てください。「原価が材料から製品へ流れる」とわかるだけで、後半の伸び方が変わります。']
  ],
  'boki.html': [
    ['question', '受験生', '簿記って、3級から始めるべきですか？いきなり2級は無理ですか？'],
    ['note', '若葉', '初学者なら3級からがいいです。仕訳の感覚がないまま2級に入ると、工業簿記以前に商業簿記で苦しくなります。'],
    ['question', '受験生', '3級を取ったあと、すぐ2級に進んだ方がいいですか？'],
    ['note', '若葉', '記憶が新しいうちに進むのがおすすめです。3級の仕訳感覚が残っているうちに、2級の商業簿記へ橋をかけるとスムーズです。']
  ],
  'boki1.html': [
    ['question', '受験生', '簿記1級って、独学でも本当に狙えますか？'],
    ['note', '若葉', '狙えます。ただし、短期勝負というより長期戦です。特に会計学の理論で止まりやすいので、質問できる環境や動画教材を組み合わせた方が現実的です。'],
    ['question', '受験生', '最初から4科目を全部進めるべきですか？'],
    ['note', '若葉', '最初は工業簿記・原価計算から入るのがおすすめです。2級の知識が活きやすく、早めに得点源を作れるからです。']
  ],
  'fp.html': [
    ['question', '受験生', 'FP2級って、暗記だけでいけますか？'],
    ['note', '若葉', '暗記だけだと税金・金融・相続の計算で止まりやすいです。用語を覚えたら、すぐ過去問で「どう聞かれるか」まで確認しましょう。'],
    ['question', '受験生', '金財とFP協会はどっちを選べばいいですか？'],
    ['note', '若葉', '迷うならFP協会が入りやすいです。金融業界寄りで計算問題をしっかり鍛えたいなら金財も選択肢になります。']
  ],
  'keizoku.html': [
    ['question', '受験生', '勉強を続けたいのに、毎回途中で止まります。意志が弱いんでしょうか？'],
    ['note', '若葉', '意志だけの問題ではないです。続く人は、やる気がある日だけ頑張っているのではなく、記録・時間帯・小さい目標を仕組みにしています。'],
    ['question', '受験生', 'まず何から変えればいいですか？'],
    ['note', '若葉', '今日やる量を小さくしてください。「30分だけ」「問題3問だけ」でも記録に残す。継続は、完璧な日より途切れない日の方が強いです。']
  ],
  'shukatsu-shikaku.html': [
    ['question', '大学生', '就活のために資格を取るなら、何から始めるのがいいですか？'],
    ['note', '若葉', '志望業界が決まっているなら、その業界に直結する資格からです。迷っているなら、簿記2級・TOEIC・ITパスポートは使いやすい土台になります。'],
    ['question', '大学生', '資格があれば就活で有利になりますか？'],
    ['note', '若葉', '資格だけで決まるわけではありません。ただ、勉強を継続して結果を出した証拠として語れるなら、面接でかなり強くなります。']
  ],
  'hatarakinagara-shikaku.html': [
    ['question', '社会人', '働きながら資格を取るのって、やっぱりきついですか？'],
    ['note', '若葉', 'きついです。だからこそ、最初から長時間を狙わない方がいいです。平日は短く、休日に少し厚くする設計が現実的です。'],
    ['question', '社会人', '途中で疲れて止まるのが怖いです。'],
    ['note', '若葉', '疲れる前提で計画しましょう。毎日2時間ではなく、平日30分でも進む資格を選ぶと、合格までの道が見えやすくなります。']
  ],
  'tenshoku-shikaku.html': [
    ['question', '社会人', '転職のために資格を取れば、すぐ有利になりますか？'],
    ['note', '若葉', '資格単体ではなく、実務経験と組み合わせて強くなります。経理なら簿記、不動産なら宅建、ITなら基本情報のように、職種とつなげて選ぶのが大事です。'],
    ['question', '社会人', '迷ったらどの資格を選ぶべきですか？'],
    ['note', '若葉', '転職先の求人票を見て、よく出てくる資格を選んでください。市場が求めている言葉に合わせるのが一番堅いです。']
  ],
  'univ-boki-units.html': [
    ['question', '大学生', '大学の会計の授業って、資格勉強と一緒に進めた方がいいですか？'],
    ['note', '若葉', '絶対に一緒に進めた方がいいです。資格テキストで予備知識があると、同じ内容が講義で出たとき「知ってる！」となって定着率が全然違います。'],
    ['question', '大学生', '教授への質問って、実際に行ったことありますか？'],
    ['note', '若葉', 'あります。連結会計の内部取引消去で詰まっていたとき、オフィスアワーで教授に聞いたら1時間みっちり教えてもらいました。無料の個別指導は本当に最強です。']
  ]
};
...
function getArticleDialogue(){
  ...
  if(article.label.includes('簿記')){
    return [
      ...
      ['note', '若葉', '簿記は用語だけを追うと難しく見えます。まず「何が増えて、何が減ったのか」を先に見てから仕訳に戻ると理解しやすいです。'],
      ['question', '受験生', 'いきなり暗記しなくてもいいんですか？'],
      ['note', '若葉', '最初は暗記より流れです。例題を1つ解いて、なぜその科目が左・右に来るのかを確認しましょう。']
    ];
  }
  if(article.label.includes('資格比較')){
    return [
      ['question', '受験生', 'どっちを選べばいいか、調べるほど迷います。'],
      ['note', '若葉', '迷ったときは、難易度より「合格後に何へつながるか」で見てください。資格は取ることより、次の行動に使えることが大事です。'],
      ['question', '受験生', '自分に合う方を選ぶコツはありますか？'],
      ['note', '若葉', '今の生活で続けられる勉強量と、目指す仕事に近い方を選ぶのが現実的です。続かない計画は、どれだけ正しくても機能しません。']
    ];
  }
  if(['まとめ','社会人向け','大学生向け','勉強法','継続・ツール','挫折・再開'].some(label => article.label.includes(label))){
    return [
      ['question', '受験生', '資格が多すぎて、何から始めればいいかわかりません。'],
      ['note', '若葉', 'まずは「今の自分に必要な理由」がある資格に絞りましょう。人気ランキングより、生活に組み込めるかが大切です。'],
      ['question', '受験生', '途中で飽きそうなのが不安です。'],
      ['note', '若葉', '飽きる前提で、記録と小さな達成感を作るのがおすすめです。続けられる仕組みまで含めて資格選びです。']
    ];
  }
  return [
    ['question', '受験生', 'この資格、独学でも進められますか？'],
    ['note', '若葉', '独学でも進められます。ただし、最初に試験範囲と必要時間を把握して、教材を1つに絞ることが大事です。'],
    ['question', '受験生', '最初に全部理解しようとしなくてもいいですか？'],
    ['note', '若葉', '大丈夫です。1周目は全体像、2周目で理解、問題演習で定着。この順番で進めると迷いにくくなります。']
  ];
}
...
html[data-theme="light"] .tip{
  background:linear-gradient(180deg,#F4FBEA,#EDF8DF) !important;
  border-color:rgba(140,198,63,.24) !important;
  color:#2D3748 !important;
}
html[data-theme="light"] .tip strong{color:#547C17 !important;}
html[data-theme="light"] .warn{
  background:linear-gradient(180deg,#FFF9E8,#FFF3CF) !important;
  border-color:rgba(246,224,94,.34) !important;
  color:#2D3748 !important;
}
html[data-theme="light"] .warn strong{color:#A06A00 !important;}
...
html[data-theme="dark"] nav{background:rgba(10,14,22,.72) !important;backdrop-filter:blur(20px) saturate(200%) !important;-webkit-backdrop-filter:blur(20px) saturate(200%) !important;border-bottom:1px solid rgba(140,198,63,.14) !important;}
...
html[data-theme="dark"] .tip{
  background:linear-gradient(180deg,#102218,#0E1A15) !important;
  border-color:rgba(140,198,63,.30) !important;
  color:#DDEBCF !important;
}
html[data-theme="dark"] .tip strong{color:#B6E27C !important;}
html[data-theme="dark"] .warn{
  background:linear-gradient(180deg,#2A210E,#1C160A) !important;
  border-color:rgba(246,224,94,.34) !important;
  color:#F4E8C2 !important;
}
html[data-theme="dark"] .warn strong{color:#F7D774 !important;}
...
.sq-thumb{display:block;width:calc(100% + 32px);height:auto;margin:-14px -16px 12px;aspect-ratio:16/9;object-fit:cover;object-position:center top;background:#fff;border-bottom:1px solid var(--sq-border-strong);}
...
html[data-theme="dark"] .bm-label{color:#C4B5FD !important;}
...
html[data-theme="dark"] .bm-block.i1 .bm-num{color:#93C5FD !important;}
...
function buildArticleDialogue(){
  const container = document.querySelector('.container');
  if(!container) return;
  if(normalizeExistingDialogue(container)) return;
...
const BOKI3_FILES = [
  ...
  'boki-careless-miss.html','boki-note-sekkei.html','boki-net-id-check.html','boki-net-test-mac-ipad.html','boki-zasetsu-type.html','boki-benkyo-basho.html','boki3-tobashi-2kyu.html',
];
...
const BOKI2_FILES = ['boki2.html', ...BOKI2_COMMERCIAL_FILES, ...BOKI2_INDUSTRIAL_FILES, 'boki2-oyoryoku-kabe.html', 'boki2-renketsu-suteru.html', 'boki2-moshi-honban.html', 'boki2-ochita.html', 'boki-careless-miss.html', 'boki-note-sekkei.html', 'boki-net-id-check.html', 'boki-net-test-mac-ipad.html', 'boki2-3kyu-fukushu.html', 'boki-zasetsu-type.html', 'boki-benkyo-basho.html'];
...
const LEARNING_DIAGNOSTICS = {
  ...
  'boki3-genkin.html': {
    prompt: '小切手を受け取ったとき、振出人と「直ちに当座預金へ預け入れた」かで、借方が現金か当座預金かを判断できますか？',
    next: '上の3問を解き、迷った小切手について「振出人」を1行で書く。'
  },
  'fp3.html': {
...
/* 表示実績のある記事へ、記事固有の判断メモを追加する。 */
Object.assign(ORIGINALITY_NOTES, {
  'kenchiku.html': {
    title: '二級建築士は「学科」と「製図」を別の試験として設計する',
    lead: 'このページでは、勉強時間の大きさだけで不安を煽らず、学科と製図を別の作業として分けます。知識を覚える時間と、条件を読み図面へ変換する時間は、同じチェック欄で管理しない方が現在地を見誤りにくいという編集判断です。',
    points: [
      '学科は科目別の正答率、製図は完成時間と失格条件の確認を別々に記録する。',
      '法規は条文を覚えた量ではなく、法令集で目的の条文へ到達する時間を測る。',
      '製図練習では美しさより先に、要求室・面積・動線を満たして時間内に完成するかを確認する。'
    ]
  },
  'boki-zero-02.html': {
    title: '簿記の価値を「資格」から「数字を読む行動」へ変換する',
    lead: 'ゼロからの簿記シリーズでは、簿記を経理職だけの技能として閉じません。学習した内容を、仕事の数字や企業ニュースを読む場面へどう移すかまでを1つの到達点にします。',
    points: [
      '売上・原価・利益の3つを見たら、利益率と現金の動きに追加の疑問を1つ書く。',
      '「役立つ」と感じた場面を抽象的な感想で終わらせず、読めるようになった数字を具体的に残す。',
      '第3回以降は用語の暗記だけでなく、取引が仕訳と財務諸表へ流れる順番を説明できるかで復習する。'
    ]
  },
  'boki1-kawase-yoyaku-furiate-vs-dokuritsu.html': {
    title: '為替予約は、最初に「本体」と「道具」を2本に分ける',
    lead: 'この論点で混乱しやすいのは、計算式よりも、ヘッジ対象とヘッジ手段を同じものとして追ってしまうことです。Study Questでは、日付・レート・本体・道具を4列に分けてから仕訳へ進む順番を採用します。',
    points: [
      '例題を読む最初の30秒で、買掛金などのヘッジ対象と為替予約を別欄に書く。',
      '決算時は対象の換算と予約の評価を別々に計算し、差損益の符号を最後に検算する。',
      '振当処理と独立処理を暗記で比較せず、「固定して終わるか、2本立てで動くか」で説明できるか確認する。'
    ]
  },
  'boki1-kigyoketsugo-vs-renketsu.html': {
    title: '企業結合と連結は、時間軸を置くと切り分けられる',
    lead: '似た言葉を定義だけで覚えると、どの場面の会計処理かを見失います。このページでは「取得した瞬間」と「支配が続く期間」という時間軸を置き、論点を別の箱へ入れることを優先します。',
    points: [
      '問題文を読んだら、取得日・決算日・支配関係の3点に印を付ける。',
      '企業結合の処理か連結上の調整かを決めてから、のれんや内部取引の論点へ進む。',
      '最後に「いつ発生した差額か」を1行で説明し、用語の丸暗記になっていないか確認する。'
    ]
  },
  'boki1-taishoku-kanbenho-vs-gensokuho.html': {
    title: '退職給付会計は「結果」と「動き」を分けて見る',
    lead: '簡便法と原則法の差を計算量だけで説明しないのが、この記事の方針です。期末に見える結果だけを見る方法と、期間中の債務・費用・積立の動きを追う方法として整理すると、仕訳の位置づけを確認しやすくなります。',
    points: [
      'まず簡便法か原則法かを問題文で確定し、途中で計算方法を混ぜない。',
      '原則法では期首残高・当期増減・期末残高を表にして、3つの動きを追う。',
      '仕訳を完成させた後、貸借の残高が問題文の制度と矛盾していないかを確認する。'
    ]
  },
  'boki2-cvp.html': {
    title: 'CVP分析は公式暗記ではなく、利益の逆算表で解く',
    lead: 'CVP分析の記事では、損益分岐点の公式を並べるだけで終わらせません。売上高・変動費・固定費・目標利益を同じ表に置き、「何を増やすと利益が動くのか」を先に確認する学習順を採用します。',
    points: [
      '問題文から固定費と変動費を分け、貢献利益率を作ってから売上高を逆算する。',
      '損益分岐点、安全余裕率、目標利益の問題を同じ式として扱わず、求めるものを先に丸で囲む。',
      '答えが出たら、販売量が増えたとき利益が増える向きになっているかを常識チェックする。'
    ]
  },
  'itp-vs-fe.html': {
    title: 'IT資格の比較は、難易度ではなく学習の転換点で決める',
    lead: 'ITパスポートと基本情報を単純な上下関係で並べず、どこで学習方法が変わるかを比較します。知識問題の復習からアルゴリズム・擬似言語へ移れる生活環境があるかを、資格名より先に確認する編集判断です。',
    points: [
      '今の目的を「ITの共通知識」か「開発・技術職への準備」かのどちらかに仮置きする。',
      '基本情報を選ぶ場合は、アルゴリズムを読む時間を週に確保できるか先に試す。',
      '2週間だけ過去問と教材を触り、用語学習と手を動かす学習のどちらを継続できるかで最終判断する。'
    ]
  },
  'fe-vs-ap.html': {
    title: 'FEとAPは、資格の格ではなく仕事との接続で選ぶ',
    lead: '基本情報と応用情報の比較で、上位資格を一律にすすめないのがこの記事の立場です。現在の実務経験、午後問題の読み書き、次に目指す仕事を3つに分けてから、受験順を決めます。',
    points: [
      'まず求人票や業務内容から、開発・運用・企画のどこへ進みたいかを書き出す。',
      'FEはアルゴリズム、APは記述式の説明というように、苦手の種類を問題演習で確かめる。',
      '「上位だから受ける」を理由にせず、3か月後に学習成果を確認できる試験から始める。'
    ]
  },
  'eiken.html': {
    title: '英検2級の標準ルートは、3か月の実行計画として使う',
    lead: 'このページは、英検2級を初めて計画する人が、3か月で一次・二次の全体像をつかむための入口です。詳しい要約・英作文対策を探している人は、別の攻略ガイドへ進むよう役割を分けています。',
    points: [
      '最初の1週間で語彙・読解・英作文・リスニングを試し、最も大きい失点要因を1つ決める。',
      '一次対策だけに偏らず、面接で使う音読を週の早い段階から少量入れる。',
      '受験日から逆算し、3か月で間に合わない場合は期間を延ばすか、次回受験へ回す判断をする。'
    ]
  },
  'eiken2.html': {
    title: '英検2級攻略ガイドは、高校生・大学受験生の6か月設計に絞る',
    lead: '英検2級の記事が重複しないよう、このページは高校生・大学受験生向けに、要約・英作文・面接を学校生活と並行して積み上げる設計へ絞ります。標準的な3か月の全体像は英検2級の入口記事で確認してください。',
    points: [
      '学校の定期試験・入試日程を先に置き、英検だけで週の計画を埋めない。',
      '要約と英作文は模範解答を写して終わらせず、制限時間内に自分の答案を作って比較する。',
      '面接練習は直前にまとめず、音読・録音・言い直しを小さく繰り返して記録する。'
    ]
  },
  'dokugaku-shikaku.html': {
    title: '資格ランキングの順位より、自分の採点表を残す',
    lead: 'ランキング記事の独自性は、人気順を並べることではなく、独学で続けられる条件を比較できることにあります。Study Questでは、教材の入手性、質問・採点の手段、学習時間、資格取得後の用途を分けて見ます。',
    points: [
      '候補を見つけたら、公式試験案内で受験条件・費用・試験形式を確認する。',
      '「独学向き」を、教材があるかだけでなく、答案を自分で検証できるかで判断する。',
      'ランキングの順位をそのまま信じず、半年後に使いたい場面と週の学習時間で自分用に並べ替える。'
    ]
  }
});
})();
