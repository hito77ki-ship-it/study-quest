...
const ARTICLE_DIALOGUES = {
  ...
  'boki2-ochita.html': [
    ['question', '受験生', '結果画面に「不合格」って出た瞬間、本当に頭が真っ白になりました……。もうテキストから買い直した方がいいですかね？'],
    ['note', '若葉', 'その気持ち、痛いほどわかります。でも断言します、テキストの買い直しは9割不要です。落ちた原因って、実は教材じゃなくて「どこで何点落としたか」を整理できていないだけなんですよ。'],
    ['question', '受験生', '整理、ですか……全部あやふやな気がして、どこから手をつけていいか分かりません。'],
    ['note', '若葉', 'だからこそ「ハコ分け」です。理解不足・演習量不足・特定論点の失点・時間切れ、この4つのハコのどれに当てはまるかを先に決める。ハコさえ特定できれば、直す場所はピンポイントで済みます。'],
    ['question', '受験生', '全範囲やり直さなくても、本当に合格できますか？'],
    ['note', '若葉', 'できます。今のあなたは知識ゼロの初学者じゃなくて、一度本番を経験して弱点まで分かっている状態です。ハコを潰せば、いわば「強くてニューゲーム」。次はもっと有利な位置からスタートできますよ。']
  ],
