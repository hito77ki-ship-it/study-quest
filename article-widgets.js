...
const ARTICLE_DIALOGUES = {
  'toeic-600.html': [
    ...
    ['teacher', '若葉', 'その気持ち、めちゃくちゃ分かります。でも600点突破のチート技は、満点を狙いにいかないことなんだ！全部読もうとするから絶望するんだよ。'],
    ['student', '受験生', 'え、読まなくていいんですか……？'],
    ['teacher', '若葉', 'まずは点数が伸びやすいリスニングと、パターンで秒殺できるPart5の「文法・単語のハコ」を最優先で味方につける。そしてPart7の最後は、綺麗に塗り絵（選択肢を統一してマーク）する。600点はそういう割り切りゲームなんだよ。']
  ],
  'fe-vs-ap.html': [
    ['student', '受験生', 'プログラミングが本当に苦手で、基本情報の午後試験（アルゴリズム必須）が不安すぎます……。'],
    ['teacher', '若葉', 'その悩み、めちゃくちゃ分かります。実はプログラミングが苦手なら、無理に基本情報で消耗するより、最初から応用情報を狙う手もあるんだよ。'],
    ['student', '受験生', 'え、応用情報の方が難しいんじゃないんですか？'],
    ['teacher', '若葉', '応用情報の午後試験は11題から5題を選べるから、「経営戦略」「サービスマネジメント」みたいな文系科目だけで固めれば、プログラミングなしで合格ラインに届く。実は基本情報より戦いやすいケースもあるんだよ。']
  ],
  'daigakusei-keizai-shikaku.html': [
    ['student', '後輩', 'なんとなく周りに流されて、就活のためにTOEICでも受けようかなと思ってます……600点くらい取れれば安心ですよね？'],
    ['teacher', '若葉', 'ちょっと待って。経済・経営学部の最大の強みは「数字（会計）が読めること」なんだ。評価のブレが大きい英語に先に逃げる前に、市場価値がほぼ確定している日商簿記2級のハコ（盾）を最優先で回収しにいくのが、一番賢いチート戦略だよ。'],
    ['student', '後輩', 'TOEICより簿記の方が優先なんですか？意外です……。'],
    ['teacher', '若葉', 'TOEIC600点台は、正直なところ就活市場ではほとんど評価されないのが現実。同じ時間を使うなら簿記2級を取った方が、面接官の反応は全然違う。英語は簿記を固めてから、730点以上を本気で狙う方が費用対効果が高いよ。']
  ],
  'boki2-ochita.html': [
    ['student', '受験生', '結果画面に「不合格」って出た瞬間、本当に頭が真っ白になりました……。もうテキストから買い直した方がいいですかね？'],
    ['teacher', '若葉', 'その気持ち、痛いほどわかります。でも断言します、テキストの買い直しは9割不要です。落ちた原因って、実は教材じゃなくて「どこで何点落としたか」を整理できていないだけなんですよ。'],
    ['student', '受験生', '整理、ですか……全部あやふやな気がして、どこから手をつけていいか分かりません。'],
    ['teacher', '若葉', 'だからこそ「ハコ分け」です。理解不足・演習量不足・特定論点の失点・時間切れ、この4つのハコのどれに当てはまるかを先に決める。ハコさえ特定できれば、直す場所はピンポイントで済みます。'],
    ['student', '受験生', '全範囲やり直さなくても、本当に合格できますか？'],
    ['teacher', '若葉', 'できます。今のあなたは知識ゼロの初学者じゃなくて、一度本番を経験して弱点まで分かっている状態です。ハコを潰せば、いわば「強くてニューゲーム」。次はもっと有利な位置からスタートできますよ。']
  ],
  'boki2-moshi-honban.html': [
    ['student', '受験生', '模試だと7割取れるのに、本番の過去問だと急に解けなくなります……。自分は本番に弱いんでしょうか？'],
    ['teacher', '若葉', 'その結論、実はちょっと早いです。原因は「性格」じゃなく、①言い回しへの対応力②時間配分③特定分野の穴のどれかであることがほとんどですよ。'],
    ['student', '受験生', 'どうやって見分ければいいですか？'],
    ['teacher', '若葉', '直近の模試の間違いを「知識不足・読み取りミス・計算ミス・時間切れ」に分類してみてください。どれが一番多いかで、直す場所がかなり絞れます。']
  ],
  'boki2-cbt-vs-paper.html': [
    ['student', '受験生', 'ネット試験と紙の試験、どっちの方が合格しやすいですか？'],
    ['teacher', '若葉', '難易度の安定性はCBTが有利です。ただし2級は複雑な下書きが増えるので、PC画面だと計算用紙のやりくりが大変になります。どちらが合うかは自分のスタイル次第です。'],
    ['student', '受験生', '計算用紙って、どうやって工夫すればいいですか？'],
    ['teacher', '若葉', '1枚を4分割して、問題番号ごとにエリアを決めておくのが一番です。本番前の模試で練習しておくと焦らなくなります。']
  ],
  'boki2-next-exam.html': [
    ['student', '受験生', 'ネット試験って、統一試験より難しかったりしますか？'],
    ['teacher', '若葉', '試験範囲も合格基準（70点）も同じです。問題がランダム出題なのでヤマを張りにくいですが、それはお互い様なので気にしなくていいです。'],
    ['student', '受験生', '3ヶ月で本当に間に合いますか？'],
    ['teacher', '若葉', '1日2〜3時間確保できれば十分狙えます。ネット試験は「準備できたら受ける」ができるので、3ヶ月があくまで目安。仕上がったタイミングで即申し込みが最速ルートです。']
  ],
  'boki2.html': [
    ['student', '受験生', '簿記2級って、3級の延長だと思って始めても大丈夫ですか？'],
    ['teacher', '若葉', '半分はその通りです。ただ、工業簿記はまったく新しい科目なので、3級の延長だけで考えると途中で止まりやすいです。'],
    ['student', '受験生', 'じゃあ最初に何を意識すればいいですか？'],
    ['teacher', '若葉', '商業簿記を進めながら、早い段階で工業簿記の全体像だけでも見てください。「原価が材料から製品へ流れる」とわかるだけで、後半の伸び方が変わります。']
  ],
  'boki.html': [
    ['student', '受験生', '簿記って、3級から始めるべきですか？いきなり2級は無理ですか？'],
    ['teacher', '若葉', '初学者なら3級からがいいです。仕訳の感覚がないまま2級に入ると、工業簿記以前に商業簿記で苦しくなります。'],
    ['student', '受験生', '3級を取ったあと、すぐ2級に進んだ方がいいですか？'],
    ['teacher', '若葉', '記憶が新しいうちに進むのがおすすめです。3級の仕訳感覚が残っているうちに、2級の商業簿記へ橋をかけるとスムーズです。']
  ],
  'boki1.html': [
    ['student', '受験生', '簿記1級って、独学でも本当に狙えますか？'],
    ['teacher', '若葉', '狙えます。ただし、短期勝負というより長期戦です。特に会計学の理論で止まりやすいので、質問できる環境や動画教材を組み合わせた方が現実的です。'],
    ['student', '受験生', '最初から4科目を全部進めるべきですか？'],
    ['teacher', '若葉', '最初は工業簿記・原価計算から入るのがおすすめです。2級の知識が活きやすく、早めに得点源を作れるからです。']
  ],
  'fp.html': [
    ['student', '受験生', 'FP2級って、暗記だけでいけますか？'],
    ['teacher', '若葉', '暗記だけだと税金・金融・相続の計算で止まりやすいです。用語を覚えたら、すぐ過去問で「どう聞かれるか」まで確認しましょう。'],
    ['student', '受験生', '金財とFP協会はどっちを選べばいいですか？'],
    ['teacher', '若葉', '迷うならFP協会が入りやすいです。金融業界寄りで計算問題をしっかり鍛えたいなら金財も選択肢になります。']
  ],
  'keizoku.html': [
    ['student', '受験生', '勉強を続けたいのに、毎回途中で止まります。意志が弱いんでしょうか？'],
    ['teacher', '若葉', '意志だけの問題ではないです。続く人は、やる気がある日だけ頑張っているのではなく、記録・時間帯・小さい目標を仕組みにしています。'],
    ['student', '受験生', 'まず何から変えればいいですか？'],
    ['teacher', '若葉', '今日やる量を小さくしてください。「30分だけ」「問題3問だけ」でも記録に残す。継続は、完璧な日より途切れない日の方が強いです。']
  ],
  'shukatsu-shikaku.html': [
    ['student', '大学生', '就活のために資格を取るなら、何から始めるのがいいですか？'],
    ['teacher', '若葉', '志望業界が決まっているなら、その業界に直結する資格からです。迷っているなら、簿記2級・TOEIC・ITパスポートは使いやすい土台になります。'],
    ['student', '大学生', '資格があれば就活で有利になりますか？'],
    ['teacher', '若葉', '資格だけで決まるわけではありません。ただ、勉強を継続して結果を出した証拠として語れるなら、面接でかなり強くなります。']
  ],
  'hatarakinagara-shikaku.html': [
    ['student', '社会人', '働きながら資格を取るのって、やっぱりきついですか？'],
    ['teacher', '若葉', 'きついです。だからこそ、最初から長時間を狙わない方がいいです。平日は短く、休日に少し厚くする設計が現実的です。'],
    ['student', '社会人', '途中で疲れて止まるのが怖いです。'],
    ['teacher', '若葉', '疲れる前提で計画しましょう。毎日2時間ではなく、平日30分でも進む資格を選ぶと、合格までの道が見えやすくなります。']
  ],
  'tenshoku-shikaku.html': [
    ['student', '社会人', '転職のために資格を取れば、すぐ有利になりますか？'],
    ['teacher', '若葉', '資格単体ではなく、実務経験と組み合わせて強くなります。経理なら簿記、不動産なら宅建、ITなら基本情報のように、職種とつなげて選ぶのが大事です。'],
    ['student', '社会人', '迷ったらどの資格を選ぶべきですか？'],
    ['teacher', '若葉', '転職先の求人票を見て、よく出てくる資格を選んでください。市場が求めている言葉に合わせるのが一番堅いです。']
  ],
  'univ-boki-units.html': [
    ['student', '大学生', '大学の会計の授業って、資格勉強と一緒に進めた方がいいですか？'],
    ['teacher', '若葉', '絶対に一緒に進めた方がいいです。資格テキストで予備知識があると、同じ内容が講義で出たとき「知ってる！」となって定着率が全然違います。'],
    ['student', '大学生', '教授への質問って、実際に行ったことありますか？'],
    ['teacher', '若葉', 'あります。連結会計の内部取引消去で詰まっていたとき、オフィスアワーで教授に聞いたら1時間みっちり教えてもらいました。無料の個別指導は本当に最強です。']
  ]
};
...
function getArticleDialogue(){
  ...
  if(article.label.includes('簿記')){
    return [
      ...
      ['teacher', '若葉', '簿記は用語だけを追うと難しく見えます。まず「何が増えて、何が減ったのか」を先に見てから仕訳に戻ると理解しやすいです。'],
      ['student', '受験生', 'いきなり暗記しなくてもいいんですか？'],
      ['teacher', '若葉', '最初は暗記より流れです。例題を1つ解いて、なぜその科目が左・右に来るのかを確認しましょう。']
    ];
  }
  if(article.label.includes('資格比較')){
    return [
      ['student', '受験生', 'どっちを選べばいいか、調べるほど迷います。'],
      ['teacher', '若葉', '迷ったときは、難易度より「合格後に何へつながるか」で見てください。資格は取ることより、次の行動に使えることが大事です。'],
      ['student', '受験生', '自分に合う方を選ぶコツはありますか？'],
      ['teacher', '若葉', '今の生活で続けられる勉強量と、目指す仕事に近い方を選ぶのが現実的です。続かない計画は、どれだけ正しくても機能しません。']
    ];
  }
  if(['まとめ','社会人向け','大学生向け','勉強法','継続・ツール','挫折・再開'].some(label => article.label.includes(label))){
    return [
      ['student', '受験生', '資格が多すぎて、何から始めればいいかわかりません。'],
      ['teacher', '若葉', 'まずは「今の自分に必要な理由」がある資格に絞りましょう。人気ランキングより、生活に組み込めるかが大切です。'],
      ['student', '受験生', '途中で飽きそうなのが不安です。'],
      ['teacher', '若葉', '飽きる前提で、記録と小さな達成感を作るのがおすすめです。続けられる仕組みまで含めて資格選びです。']
    ];
  }
  return [
    ['student', '受験生', 'この資格、独学でも進められますか？'],
    ['teacher', '若葉', '独学でも進められます。ただし、最初に試験範囲と必要時間を把握して、教材を1つに絞ることが大事です。'],
    ['student', '受験生', '最初に全部理解しようとしなくてもいいですか？'],
    ['teacher', '若葉', '大丈夫です。1周目は全体像、2周目で理解、問題演習で定着。この順番で進めると迷いにくくなります。']
  ];
}
